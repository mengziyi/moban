...
public class Shard { // S类封装了机器节点的信息 ，如name、password、ip、port等
      ...
      static TreeMap<Long, Node> nodes; // 虚拟节点到真实节点的映射
      static TreeMap<Long,Node> treeKey; //key到真实节点的映射
      static List<Node> shards = new ArrayList<Node>(); // 真实机器节点
    private final int NODE_NUM = 50; // 每个机器节点关联的虚拟节点个数
    boolean flag = false;
